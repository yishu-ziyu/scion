...
- `projects/chijie-browser/chrome-extension/src/background/browser/context.ts`
- `projects/chijie-browser/chrome-extension/src/background/index.ts`
- `projects/chijie-browser/chrome-extension/src/background/browser/__tests__/context.test.ts`
- `/Users/mahaoxuan/projects/chijie-browser/chrome-extension/src/background/browser/context.ts`
- `/Users/mahaoxuan/projects/chijie-browser/chrome-extension/src/background/index.ts`
- `/Users/mahaoxuan/projects/chijie-browser/chrome-extension/src/background/browser/__tests__/context.test.ts`
...
- [ ] Run `pnpm -F chrome-extension exec vitest run src/background/browser/__tests__/context.test.ts` in `/Users/mahaoxuan/projects/chijie-browser` and record the expected failures before implementation.
...
- [ ] Copy the three runtime files from `/Users/mahaoxuan/projects/chijie-browser` to scion and prove `diff -q` is silent for each file.
