...
For anything that runs in a browser, unit tests alone aren't enough — you need runtime verification. Use Chrome DevTools MCP to inspect the rendered page, DOM, console logs, network requests, performance traces, and screenshots.
