...
| product | 020 | current | 持节评估主表与运行协议 | 013/015/016/017/018 统一 task_id、矩阵列、运行顺序与验收纪律。 | 2026-08-02 | [020](docs/product/020-eval-master.md) |
| product | 019 | current | AI Agent Book 驱动的持节建设规划 | 从 Model + Harness 五要素到评估/可观测性/持续进化；先建地基，再跑证据。 | 2026-08-02 | [019](docs/product/019-ai-agent-book-build-plan.md) |
...
| product | 006 | current | 外环 RL 最小方案 | Wave 5 执行中：可验证闸门 rollout + Skill；不训权重。目录 reports/nanobrowser/outer-rl/。 | 2026-08-02 | [006](docs/product/006-outer-loop-rl-min-plan.md) |
