...
number: "004"
status: current
services: ["projects/yishu-browser", "experiments/agent-core-bakeoff"]
...
| M2 | `projects/yishu-browser/chrome-extension/src/background/agent/` | 多后端工厂 + control 环；见 `design/002` |
| M2+ | `projects/yishu-browser/` | 生产壳 + Task；换核适配器 |
