...
export const ModelSettings = ({ isDarkMode = false }: ModelSettingsProps) => {
 ...
 <div
 className={`rounded-lg border ${isDarkMode ? 'border-[var(--yishu-border)] bg-[var(--yishu-surface)]' : 'border-[var(--yishu-border)] bg-[var(--yishu-surface)]'} p-4`}>
 <h3 className={`mb-2 text-lg font-medium ${isDarkMode ? 'text-[var(--yishu-foreground)]' : 'text-[var(--yishu-foreground)]'}`}>
 {agentName.charAt(0).toUpperCase() + agentName.slice(1)}
 </h3>
 <p className={`mb-4 text-sm font-normal ${isDarkMode ? 'text-[var(--yishu-muted)]' : 'text-[var(--yishu-muted)]'}`}>
 ...
 className={`w-24 text-sm font-medium ${isDarkMode ? 'text-[var(--yishu-foreground)]' : 'text-[var(--yishu-foreground)]'}`}>
 {t('options_models_labels_model')}
 </label>
 <select
 id={`${agentName}-model`}
 className={`flex-1 rounded-md border text-sm ${isDarkMode ? 'border-[var(--yishu-border-strong)] bg-[var(--yishu-surface-raised)] text-[var(--yishu-foreground)]' : 'border-[var(--yishu-border-strong)] bg-[var(--yishu-surface-raised)] text-[var(--yishu-foreground)]'} px-3 py-2`}
 ...
 <span className={`w-12 text-sm ${isDarkMode ? 'text-[var(--yishu-foreground)]' : 'text-[var(--yishu-muted)]'}`}>
 ...
 className={`w-20 rounded-md border ${isDarkMode ? 'border-[var(--yishu-border-strong)] bg-[var(--yishu-surface-raised)] text-[var(--yishu-foreground)] focus:border-[var(--yishu-accent)] focus:ring-2 focus:ring-[var(--yishu-accent-subtle)]' : 'border-[var(--yishu-border-strong)] bg-[var(--yishu-surface-raised)] text-[var(--yishu-foreground)] focus:border-[var(--yishu-accent)] focus:ring-2 focus:ring-[var(--yishu-accent-subtle)]'} px-2 py-1 text-sm`}
 ...
 <div
 className={`rounded-lg border ${isDarkMode ? 'border-[var(--yishu-border)] bg-[var(--yishu-surface)]' : 'border-[var(--yishu-border)] bg-[var(--yishu-surface)]'} p-6 text-left `}>
 <h2 className={`mb-4 text-xl font-semibold ${isDarkMode ? 'text-[var(--yishu-foreground)]' : 'text-[var(--yishu-paper)]'}`}>
 {t('options_models_providers_header')}
 </h2>
 <div className="space-y-6">
 {getSortedProviders().length === 0 ? (
 <div className="py-8 text-center text-[var(--yishu-muted)]">
 ...
 className={`space-y-4 ${modifiedProviders.has(providerId) && !providersFromStorage.has(providerId) ? `rounded-lg border p-4 ${isDarkMode ? 'border-[var(--yishu-accent)] bg-[var(--yishu-surface-raised)]' : 'border-[var(--yishu-accent)] bg-[var(--yishu-accent-subtle)]'}` : ''}`}>
 <div className="flex items-center justify-between">
 <h3 className={`text-lg font-medium ${isDarkMode ? 'text-[var(--yishu-foreground)]' : 'text-[var(--yishu-foreground)]'}`}>
 ...
 className={`w-20 text-sm font-medium ${isDarkMode ? 'text-[var(--yishu-foreground)]' : 'text-[var(--yishu-foreground)]'}`}>
 ...
 ? isDarkMode
 ? 'border-red-700 bg-[var(--yishu-surface-raised)] text-[var(--yishu-foreground)] focus:border-red-600 focus:ring-2 focus:ring-red-900'
 : 'border-red-300 bg-[var(--yishu-surface)] focus:border-red-400 focus:ring-2 focus:ring-red-200'
 : isDarkMode
 ? 'border-[var(--yishu-accent)] bg-[var(--yishu-surface-raised)] text-[var(--yishu-foreground)] focus:border-[var(--yishu-accent)] focus:ring-2 focus:ring-[var(--yishu-accent-subtle)]'
 : 'border-[var(--yishu-border-strong)] bg-[var(--yishu-surface-raised)] focus:border-[var(--yishu-accent)] focus:ring-2 focus:ring-[var(--yishu-accent-subtle)]'
 } outline-none`}
 />
 </div>
 {nameErrors[providerId] ? (
 <p className={`ml-20 mt-1 text-xs ${isDarkMode ? 'text-[var(--yishu-accent-signal)]' : 'text-red-500'}`}>
 {nameErrors[providerId]}
 </p>
 ) : (
 <p className={`ml-20 mt-1 text-xs ${isDarkMode ? 'text-[var(--yishu-muted)]' : 'text-[var(--yishu-muted)]'}`}>
 ...
 className={`w-full rounded-md border text-sm ${isDarkMode ? 'border-[var(--yishu-border-strong)] bg-[var(--yishu-surface-raised)] text-[var(--yishu-foreground)] focus:border-[var(--yishu-accent)] focus:ring-2 focus:ring-[var(--yishu-accent-subtle)]' : 'border-[var(--yishu-border-strong)] bg-[var(--yishu-surface-raised)] text-[var(--yishu-foreground)] focus:border-[var(--yishu-accent)] focus:ring-2 focus:ring-[var(--yishu-accent-subtle)]'} p-2 outline-none`}
 />
 ...
 isDarkMode ? 'text-[var(--yishu-muted)] hover:text-[var(--yishu-foreground)]' : 'text-[var(--yishu-muted)] hover:text-[var(--yishu-foreground)]'
 }`}
 ...
 <p
 className={`break-words font-mono text-sm ${isDarkMode ? 'text-[var(--yishu-paper)]' : 'text-[var(--yishu-paper)]'}`}>
 {providerConfig.apiKey}
 </p>
 </div>
 )}
 ...
 className={`flex-1 rounded-md border text-sm ${isDarkMode ? 'border-[var(--yishu-border-strong)] bg-[var(--yishu-surface-raised)] text-[var(--yishu-foreground)] focus:border-[var(--yishu-accent)] focus:ring-2 focus:ring-[var(--yishu-accent-subtle)]' : 'border-[var(--yishu-border-strong)] bg-[var(--yishu-surface-raised)] text-[var(--yishu-foreground)] focus:border-[var(--yishu-accent)] focus:ring-2 focus:ring-[var(--yishu-accent-subtle)]'} p-2 outline-none`}
 />
 </div>
 </div>
 )}
 ...
 className={`w-20 pt-2 text-sm font-medium ${isDarkMode ? 'text-[var(--yishu-foreground)]' : 'text-[var(--yishu-foreground)]'}`}>
 {t('options_models_providers_deployment')}*
 </label>
 <div className="flex-1 space-y-2">
 <div
 className={`flex min-h-[42px] flex-wrap items-center gap-2 rounded-md border ${isDarkMode ? 'border-[var(--yishu-border-strong)] bg-[var(--yishu-surface-raised)] text-[var(--yishu-foreground)]' : 'border-[var(--yishu-border-strong)] bg-[var(--yishu-surface-raised)] text-[var(--yishu-foreground)]'} p-2`}>
 ...
 <div
 key={deploymentName}
 className={`flex items-center rounded-full ${isDarkMode ? 'bg-[var(--yishu-surface-raised)] text-[var(--yishu-paper)]' : 'bg-[var(--yishu-accent-subtle)] text-[var(--yishu-paper)]'} px-2 py-1 text-sm`}>
 <span>{deploymentName}</span>
 <button
 type="button"
 onClick={() => removeAzureDeployment(providerId, deploymentName)}
 className={`ml-1 font-bold ${isDarkMode ? 'text-[var(--yishu-muted)] hover:text-[var(--yishu-paper)]' : 'text-[var(--yishu-paper)] hover:text-[var(--yishu-paper)]'}`}
 ...
 className={`min-w-[150px] flex-1 border-none text-sm ${isDarkMode ? 'bg-transparent text-[var(--yishu-foreground)]' : 'bg-transparent text-[var(--yishu-foreground)]'} p-1 outline-none`}
 />
 </div>
 <p className={`mt-1 text-xs ${isDarkMode ? 'text-[var(--yishu-muted)]' : 'text-[var(--yishu-muted)]'}`}>
 ...
 <span className={`text-xs ${isDarkMode ? 'text-[var(--yishu-muted)]' : 'text-[var(--yishu-muted)]'}`}>
 ...
 {providerConfig.type === ProviderTypeEnum.Ollama && (
 <div
 className={`mt-4 rounded-md border ${isDarkMode ? 'border-[var(--yishu-border-strong)] bg-[var(--yishu-surface-raised)]' : 'border-[var(--yishu-border)] bg-[var(--yishu-surface-raised)]'} p-3`}>
 <p className={`text-sm ${isDarkMode ? 'text-[var(--yishu-foreground)]' : 'text-[var(--yishu-foreground)]'}`}>
 <strong>
 {' '}
 <code
 className={`rounded italic ${isDarkMode ? 'bg-[var(--yishu-border-strong)] px-1 py-0.5' : 'bg-[var(--yishu-accent-subtle)] px-1 py-0.5'}`}>
 ...
 className={`ml-1 ${isDarkMode ? 'text-[var(--yishu-muted)] hover:text-[var(--yishu-muted)]' : 'text-[var(--yishu-paper)] hover:text-[var(--yishu-paper)]'}`}>
 ...
 <div className={`mt-4 border-t ${isDarkMode ? 'border-[var(--yishu-border)]' : 'border-[var(--yishu-border)]'}`} />
 )}
 </div>
 );
 })
 ...
 isDarkMode
 ? 'border-[var(--yishu-accent)] bg-[var(--yishu-accent)] text-[var(--yishu-foreground)] hover:bg-[var(--yishu-accent)]'
 : 'border-[var(--yishu-border)] bg-[var(--yishu-accent-subtle)] text-[var(--yishu-paper)] hover:bg-[var(--yishu-accent-subtle)]'
 }`}>
 ...
 isDarkMode
 ? 'border-[var(--yishu-accent)] bg-[var(--yishu-surface-raised)]'
 : 'border-[var(--yishu-border)] bg-[var(--yishu-surface-raised)]'
 }`}>
 <div className="py-1">
 ...
 isDarkMode
 ? 'text-[var(--yishu-muted)] hover:bg-[var(--yishu-accent)]/30 hover:text-[var(--yishu-foreground)]'
 : 'text-[var(--yishu-paper)] hover:bg-[var(--yishu-accent-subtle)] hover:text-[var(--yishu-paper)]'
 ...
 <div
 className={`rounded-lg border ${isDarkMode ? 'border-[var(--yishu-border)] bg-[var(--yishu-surface)]' : 'border-[var(--yishu-border)] bg-[var(--yishu-surface)]'} p-6 text-left `}>
 <h2 className={`mb-4 text-left text-xl font-semibold ${isDarkMode ? 'text-[var(--yishu-foreground)]' : 'text-[var(--yishu-paper)]'}`}>
 ...
 <p className={`mb-4 text-sm ${isDarkMode ? 'text-[var(--yishu-muted)]' : 'text-[var(--yishu-muted)]'}`}>
