...
export const ModelSettings = ({ isDarkMode = false }: ModelSettingsProps) => {
 ...
 <h3 className={`mb-2 text-lg font-medium ${isDarkMode ? 'text-[var(--chijie-foreground)]' : 'text-[var(--chijie-foreground)]'}`}>
 {agentName.charAt(0).toUpperCase() + agentName.slice(1)}
 </h3>
 <p className={`mb-4 text-sm font-normal ${isDarkMode ? 'text-[var(--chijie-muted)]' : 'text-[var(--chijie-muted)]'}`}>
 ...
 <span className={`w-12 text-sm ${isDarkMode ? 'text-[var(--chijie-foreground)]' : 'text-[var(--chijie-muted)]'}`}>
 ...
 <div className="py-8 text-center text-[var(--chijie-muted)]">
 ...
 className={`space-y-4 ${modifiedProviders.has(providerId) && !providersFromStorage.has(providerId) ? `rounded-lg border p-4 ${isDarkMode ? 'border-[var(--chijie-accent)] bg-[var(--chijie-surface-raised)]' : 'border-[var(--chijie-accent)] bg-[var(--chijie-accent-subtle)]'}` : ''}`}>
 <div className="flex items-center justify-between">
 <h3 className={`text-lg font-medium ${isDarkMode ? 'text-[var(--chijie-foreground)]' : 'text-[var(--chijie-foreground)]'}`}>
 ...
 className={`w-20 text-sm font-medium ${isDarkMode ? 'text-[var(--chijie-foreground)]' : 'text-[var(--chijie-foreground)]'}`}>
 ...
 ? isDarkMode
 ? 'border-red-700 bg-[var(--chijie-surface-raised)] text-[var(--chijie-foreground)] focus:border-red-600 focus:ring-2 focus:ring-red-900'
 : 'border-red-300 bg-[var(--chijie-surface)] focus:border-red-400 focus:ring-2 focus:ring-red-200'
 : isDarkMode
 ? 'border-[var(--chijie-accent)] bg-[var(--chijie-surface-raised)] text-[var(--chijie-foreground)] focus:border-[var(--chijie-accent)] focus:ring-2 focus:ring-[var(--chijie-accent-subtle)]'
 : 'border-[var(--chijie-border-strong)] bg-[var(--chijie-surface-raised)] focus:border-[var(--chijie-accent)] focus:ring-2 focus:ring-[var(--chijie-accent-subtle)]'
 } outline-none`}
 />
 </div>
 {nameErrors[providerId] ? (
 <p className={`ml-20 mt-1 text-xs ${isDarkMode ? 'text-[var(--chijie-accent-signal)]' : 'text-red-500'}`}>
 {nameErrors[providerId]}
 </p>
 ) : (
 <p className={`ml-20 mt-1 text-xs ${isDarkMode ? 'text-[var(--chijie-muted)]' : 'text-[var(--chijie-muted)]'}`}>
 ...
 className={`w-full rounded-md border text-sm ${isDarkMode ? 'border-[var(--chijie-border-strong)] bg-[var(--chijie-surface-raised)] text-[var(--chijie-foreground)] focus:border-[var(--chijie-accent)] focus:ring-2 focus:ring-[var(--chijie-accent-subtle)]' : 'border-[var(--chijie-border-strong)] bg-[var(--chijie-surface-raised)] text-[var(--chijie-foreground)] focus:border-[var(--chijie-accent)] focus:ring-2 focus:ring-[var(--chijie-accent-subtle)]'} p-2 outline-none`}
 />
 ...
 isDarkMode ? 'text-[var(--chijie-muted)] hover:text-[var(--chijie-foreground)]' : 'text-[var(--chijie-muted)] hover:text-[var(--chijie-foreground)]'
 }`}
 ...
 className={`flex-1 rounded-md border text-sm ${isDarkMode ? 'border-[var(--chijie-border-strong)] bg-[var(--chijie-surface-raised)] text-[var(--chijie-foreground)] focus:border-[var(--chijie-accent)] focus:ring-2 focus:ring-[var(--chijie-accent-subtle)]' : 'border-[var(--chijie-border-strong)] bg-[var(--chijie-surface-raised)] text-[var(--chijie-foreground)] focus:border-[var(--chijie-accent)] focus:ring-2 focus:ring-[var(--chijie-accent-subtle)]'} p-2 outline-none`}
 />
 </div>
 </div>
 )}
 ...
 className={`w-20 pt-2 text-sm font-medium ${isDarkMode ? 'text-[var(--chijie-foreground)]' : 'text-[var(--chijie-foreground)]'}`}>
 {t('options_models_providers_deployment')}*
 </label>
 <div className="flex-1 space-y-2">
 <div
 className={`flex min-h-[42px] flex-wrap items-center gap-2 rounded-md border ${isDarkMode ? 'border-[var(--chijie-border-strong)] bg-[var(--chijie-surface-raised)] text-[var(--chijie-foreground)]' : 'border-[var(--chijie-border-strong)] bg-[var(--chijie-surface-raised)] text-[var(--chijie-foreground)]'} p-2`}>
 ...
 className={`min-w-[150px] flex-1 border-none text-sm ${isDarkMode ? 'bg-transparent text-[var(--chijie-foreground)]' : 'bg-transparent text-[var(--chijie-foreground)]'} p-1 outline-none`}
 />
 </div>
 <p className={`mt-1 text-xs ${isDarkMode ? 'text-[var(--chijie-muted)]' : 'text-[var(--chijie-muted)]'}`}>
 ...
 <span className={`text-xs ${isDarkMode ? 'text-[var(--chijie-muted)]' : 'text-[var(--chijie-muted)]'}`}>
 ...
 {providerConfig.type === ProviderTypeEnum.Ollama && (
 <div
 className={`mt-4 rounded-md border ${isDarkMode ? 'border-[var(--chijie-border-strong)] bg-[var(--chijie-surface-raised)]' : 'border-[var(--chijie-border)] bg-[var(--chijie-surface-raised)]'} p-3`}>
 <p className={`text-sm ${isDarkMode ? 'text-[var(--chijie-foreground)]' : 'text-[var(--chijie-foreground)]'}`}>
 <strong>
 {' '}
 <code
 className={`rounded italic ${isDarkMode ? 'bg-[var(--chijie-border-strong)] px-1 py-0.5' : 'bg-[var(--chijie-accent-subtle)] px-1 py-0.5'}`}>
 ...
 <div className={`mt-4 border-t ${isDarkMode ? 'border-[var(--chijie-border)]' : 'border-[var(--chijie-border)]'}`} />
 )}
 </div>
 );
 })
 ...
 isDarkMode
 ? 'border-[var(--chijie-accent)] bg-[var(--chijie-surface-raised)]'
 : 'border-[var(--chijie-border)] bg-[var(--chijie-surface-raised)]'
 }`}>
 <div className="py-1">
