              ...
              return (
                <div
                  ...
                  <div className="flex items-center justify-between">
                    <h3
                      className={`text-lg font-medium ${isDarkMode ? 'text-[var(--chijie-foreground)]' : 'text-[var(--chijie-foreground)]'}`}>
                  ...
                  <div className="space-y-3">
                    ...
                    {providerConfig.type === ProviderTypeEnum.CustomOpenAI && (
                      <div className="flex flex-col">
                        ...
                        {nameErrors[providerId] ? (
                          <p
                            className={`ml-20 mt-1 text-xs ${isDarkMode ? 'text-[var(--chijie-accent-signal)]' : 'text-red-500'}`}>
                            {nameErrors[providerId]}
                          </p>
                        ) : (
                          <p
                            className={`ml-20 mt-1 text-xs ${isDarkMode ? 'text-[var(--chijie-muted)]' : 'text-[var(--chijie-muted)]'}`}>
                        ...
                        {modifiedProviders.has(providerId) && !providersFromStorage.has(providerId) && (
                          <button
                            ...
                            className={`absolute right-2 top-1/2 -translate-y-1/2 ${
                              isDarkMode
                                ? 'text-[var(--chijie-muted)] hover:text-[var(--chijie-foreground)]'
                                : 'text-[var(--chijie-muted)] hover:text-[var(--chijie-foreground)]'
                            }`}
                    ...
                    {(providerConfig.type as ProviderTypeEnum) === ProviderTypeEnum.AzureOpenAI && (
                      <div className="flex items-start">
                        ...
                        <div className="flex-1 space-y-2">
                          ...
                          <p
                            className={`mt-1 text-xs ${isDarkMode ? 'text-[var(--chijie-muted)]' : 'text-[var(--chijie-muted)]'}`}>
                            ...
                            <>
                              <div
                                ...
                                {providerConfig.modelNames && providerConfig.modelNames.length > 0 ? (
                                  ...
                                  <span
                                    className={`text-xs ${isDarkMode ? 'text-[var(--chijie-muted)]' : 'text-[var(--chijie-muted)]'}`}>
                    ...
                    {providerConfig.type === ProviderTypeEnum.Ollama && (
                      <div
                        ...
                        <p
                          className={`text-sm ${isDarkMode ? 'text-[var(--chijie-foreground)]' : 'text-[var(--chijie-foreground)]'}`}>
                          <strong>
                            {' '}
                            <code
                  ...
                  {Object.keys(providers).indexOf(providerId) < Object.keys(providers).length - 1 && (
                    <div
                      className={`mt-4 border-t ${isDarkMode ? 'border-[var(--chijie-border)]' : 'border-[var(--chijie-border)]'}`}
                    />
                  )}
                </div>
              );
