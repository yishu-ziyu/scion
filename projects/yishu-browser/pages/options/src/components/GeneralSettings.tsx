...
export const GeneralSettings = ({ isDarkMode = false }: GeneralSettingsProps) => {
 ...
 <div>
 <h3 className={`text-base font-medium ${isDarkMode ? 'text-[var(--yishu-foreground)]' : 'text-[var(--yishu-foreground)]'}`}>
 {t('options_general_maxSteps')}
 </h3>
 <p className={`text-sm font-normal ${isDarkMode ? 'text-[var(--yishu-muted)]' : 'text-[var(--yishu-muted)]'}`}>
 ...
 className={`w-20 rounded-md border ${isDarkMode ? 'border-[var(--yishu-border-strong)] bg-[var(--yishu-surface-raised)] text-[var(--yishu-foreground)]' : 'border-[var(--yishu-border-strong)] bg-[var(--yishu-surface-raised)] text-[var(--yishu-foreground)]'} px-3 py-2`}
 />
 </div>
 ...
 <label
 htmlFor="useVision"
 className={`peer h-6 w-11 rounded-full ${isDarkMode ? 'bg-[var(--yishu-border-strong)]' : 'bg-[var(--yishu-border-strong)]'} after:absolute after:left-[2px] after:top-[2px] after:size-5 after:rounded-full after:border after:border-[var(--yishu-border-strong)] after:bg-[var(--yishu-surface-raised)] after:transition-all after:content-[''] peer-checked:bg-[var(--yishu-accent)] peer-checked:after:translate-x-full peer-checked:after:border-white peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-[var(--yishu-accent-subtle)]`}>
