...
Never paste page source, HTML, DOM, click traces, or numbered element lists into the user-visible answer. Only tell the user what the worker summarized.`;
...
If the brief allows browser operation, call operate_browser and wait; map the outcome into the summary.
